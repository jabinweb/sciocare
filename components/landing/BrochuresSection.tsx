...
export default function BrochuresSection() {
  return (
    <section id="brochures" className="py-16 md:py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 text-center relative z-10">
        <Stethoscope className="w-12 h-12 md:w-16 md:h-16 text-white mx-auto mb-4 md:mb-6" />
